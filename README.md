...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/blitz-prisma-clientversion-error-reproduction
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/blitz-prisma-clientversion-error-reproduction_test
```
